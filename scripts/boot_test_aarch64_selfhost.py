...
LINKER_MARKER = (
    ...
    b"c_features=multi-function,parameter,pointer-parameter,local,array,array-decay,index,assignment,pointer,address-of,address-expression,dereference,if,equality,inequality,while,call,return "
    ...
    b"pointee_results=42,2 array_results=41:42,1:2 code_bytes=76,128,132 "
    b"object_bytes=688,872 intra_object_call=1 linked_bytes=336 output_bytes=815 "
    b"persisted_reopened=1 malformed_c_denied=9 "
