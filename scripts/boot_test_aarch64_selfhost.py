...
LINKER_MARKER = (
    ...
    b"c_features=multi-function,parameter,pointer-parameter,local,array,array-decay,index,assignment,pointer,pointer-add,address-of,address-expression,dereference,if,equality,inequality,while,call,return "
    ...
    b"pointee_results=42,2 array_results=41:42,1:2 pointer_offset_call=1 "
    b"code_bytes=76,136,136 object_bytes=688,880 intra_object_call=1 "
    b"linked_bytes=348 output_bytes=815 persisted_reopened=1 malformed_c_denied=11 "
...
def main() -> int:
    ...
    print(
        ...
        "pointee_results=42,2 array_results=41:42,1:2 pointer_offset_call=1 "
        "code_bytes=76,136,136 object_bytes=688,880 intra_object_call=1 "
        "linked_bytes=348 output_bytes=815 persisted_reopened=1 malformed_c_denied=11 "
