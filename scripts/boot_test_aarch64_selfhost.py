...
EXECUTION_MARKER = (
    ...
    b"symbols=_start,answer,adjust,combine c_sources=/home/user/generated-program.c,/home/user/generated-library.c "
...
def main() -> int:
    ...
    print(
        ...
        "symbols=_start,answer,adjust,combine translation_unit_functions=2,1 "
