...
LINKER_MARKER = (
    ...
    b"c_source=/home/user/generated-answer.c c_abi=aapcs64-int32-pointer64 "
    b"c_features=parameter,pointer-parameter,local,array,array-decay,index,assignment,pointer,address-of,address-expression,dereference,if,equality,inequality,while,call,return "
    ...
    b"object_bytes=688,736,688 linked_bytes=336 output_bytes=815 "
    b"persisted_reopened=1 malformed_c_denied=8 "
...
def main() -> int:
    ...
    print(
        ...
        "symbols=_start,answer,adjust c_abi=aapcs64-int32-pointer64 "
