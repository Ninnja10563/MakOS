...
LINKER_MARKER = (
    ...
    b"c_features=multi-function,multi-parameter,parameter,pointer-parameter,local,array,array-decay,index,assignment,pointer,pointer-add,pointer-variable-add,address-of,address-expression,dereference,if,equality,inequality,relational,while,call,return "
    ...
    b"pointee_results=42,44,2 delta_results=1:42,2:44,1:2 array_results=41:42:0,42:0:44,1:2:0 pointer_offset_call=1 pointer_variable_offset=delta dynamic_pointer_adds=2 signed_pointer_offset=-1:42 relational_results=gt:42:0,le:42:0,ge:42:86,lt:42:44 "
    b"code_bytes=76,140,152 object_bytes=688,904 intra_object_call=1 "
    b"linked_bytes=368 output_bytes=815 persisted_reopened=1 malformed_c_denied=15 "
...
def main() -> int:
    ...
    print(
        ...
        "code_bytes=76,140,152 object_bytes=688,904 intra_object_call=1 "
        "linked_bytes=368 output_bytes=815 persisted_reopened=1 malformed_c_denied=15 "
