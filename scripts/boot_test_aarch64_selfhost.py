...
LINKER_MARKER = (
    ...
    b"c_features=parameter,local,assignment,if,equality,inequality,while,call,return "
    b"nonleaf_frame=64 c_operators=mul,sub,add branch_results=42,86 "
    b"loop_results=42,2 code_bytes=76,116,108 object_bytes=688,728,664 "
    b"linked_bytes=300 output_bytes=815 persisted_reopened=1 malformed_c_denied=4 "
