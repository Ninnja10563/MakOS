...
LINKER_MARKER = (
    ...
    b"c_features=parameter,pointer-parameter,local,assignment,pointer,address-of,address-expression,dereference,if,equality,inequality,while,call,return "
    ...
    b"pointee_results=42,2 code_bytes=76,120,132 object_bytes=688,728,688 "
    b"linked_bytes=328 output_bytes=815 persisted_reopened=1 malformed_c_denied=7 "
