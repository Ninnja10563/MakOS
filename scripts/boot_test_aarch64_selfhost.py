...
LINKER_MARKER = (
    ...
    b"code_bytes=76,140,168 object_bytes=688,920 intra_object_call=1 "
    b"linked_bytes=384 output_bytes=815 persisted_reopened=1 malformed_c_denied=16 "
...
def main() -> int:
    ...
    print(
        ...
        "code_bytes=76,140,168 object_bytes=688,920 intra_object_call=1 "
        "linked_bytes=384 output_bytes=815 persisted_reopened=1 malformed_c_denied=16 "
