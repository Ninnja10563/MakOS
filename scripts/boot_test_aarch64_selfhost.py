...
LINKER_MARKER = (
    ...
    b"c_features=parameter,local,if,equality,call,return nonleaf_frame=64 "
    b"c_operators=mul,sub,add branch_results=42,86 code_bytes=76,116,56 "
    b"object_bytes=688,728,608 linked_bytes=248 output_bytes=559 "
...
EXECUTION_MARKER = (
    ...
    b"c_abi=aapcs64-int32 c_features=parameter,local,if,equality,call,return "
    b"nonleaf_frame=64 c_operators=mul,sub,add branch_results=42,86 "
    b"code_bytes=76,116,56 object_bytes=688,728,608 linked_bytes=248 "
    b"output_bytes=559 persisted_reopened=1 malformed_c_denied=2 "
    b"malformed_relocation_denied=1 unresolved_symbol_denied=1 "
    b"duplicate_definition_denied=1 "
