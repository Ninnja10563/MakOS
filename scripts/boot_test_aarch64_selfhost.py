...
LINKER_MARKER = (
    ...
    b"c_features=multi-function,multi-parameter,three-argument,parameter,pointer-parameter,local,array,array-decay,index,assignment,pointer,pointer-add,pointer-variable-add,pointer-difference,address-of,address-expression,dereference,if,equality,inequality,relational,while,call,return "
    b"max_parameters=3 max_call_arguments=3 nonleaf_frame=96 three_argument_result=42 three_argument_link=et-rel,same-object c_operators=mul,sub,add c_relations=eq,ne,lt,le,gt,ge branch_results=42,86 "
