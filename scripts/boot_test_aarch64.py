    ...
    with tempfile.TemporaryDirectory(
        ...
        try:
            ...
            with client:
                ...
                wait_for_output(
                    selector, process, output,
                    b"MAKOS_AARCH64_MAKBUILD_OK mode=build manifest=/home/user/generated.build startup=sysv argc=2 envc=1 seeded=0 status=42",
                )
                wait_for_output(
                    selector, process, output,
