    ...
    with tempfile.TemporaryDirectory(
        ...
        try:
            ...
            required = (
                ...
                b"MAKOS_AARCH64_ABI_OK version=1.0 normative_max=57 target_extension_max=147 features=ipc,process,vm,vfs,network,graphics,auth,log,sync,ipv6,sockets,packages,vm-regions,tty-signals,typed-ipc truthful=1",
