...
require(KERNEL, "3 => SYS_TYPED_CHANNEL_RECEIVE,")
...
for bit in (0, 1, 2, 3, 4, 5, 6, 7, 8, 11, 14, 15, 16, 17, 18, 19, 20, 21):
    require(KERNEL, f"1 << {bit};")
require(INIT, "syscall2(SYS_ABI_INFO, 2, 0) != AARCH64_ABI_FEATURES")
require(INIT, "syscall2(SYS_ABI_INFO, 3, 0) != SYS_TYPED_CHANNEL_RECEIVE")
...
require(INIT, "MAKOS_AARCH64_ABI_OK version=1.0 normative_max=57 target_extension_max=147")
require(DOC, "`147` both targets")

print(
    "MAKOS_AARCH64_ABI_DISCOVERY_TEST_OK normative_max=57 "
    "target_extension_max=147 feature_mask=truthful runtime_probe=init"
)
